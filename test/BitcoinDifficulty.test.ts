...
describe("BitcoinDifficulty", function() {
  it("targetToBdiff", function() {
    let val = BitcoinDifficulty.targetToBdiff(
  ...
  it("targetToPdiff", function() {
    let val = BitcoinDifficulty.targetToPdiff(
      "0x00000000000404CB000000000000000000000000000000000000000000000000"
    )
  ...
  it("estimatedSecondsToMineBlock", function() {
    let val = BitcoinDifficulty.estimatedSecondsToMineBlock(
      20000,
      1 * GIGAHASHES
    )
  ...
  it("estimatedDaysToMineBlock 2", function() {
    let val = BitcoinDifficulty.estimatedDaysToMineBlock(
      3290605988755.001,
      1000 * TERAHASHES
    )
