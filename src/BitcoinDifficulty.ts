...
const HIGHEST_TARGET: BigNumber = hexStrToNumber('0x00000000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF')
...
const HIGHEST_TARGET_TRUNCATED: BigNumber = hexStrToNumber('0x00000000FFFF0000000000000000000000000000000000000000000000000000')
...
export class BitcoinDifficulty {
   ...
   */
  static estimatedSecondsToMineBlock (difficulty: number, hahesPerSecondHashRate: number): number {
    return difficulty * 2 ** 32 / hahesPerSecondHashRate
  }

  static estimatedHoursToMineBlock (difficulty: number, hahesPerSecondHashRate: number): number {
    return BitcoinDifficulty.estimatedSecondsToMineBlock(difficulty, hahesPerSecondHashRate) / 60 / 60.0
  }

  static estimatedDaysToMineBlock (difficulty: number, hahesPerSecondHashRate: number): number {
    return BitcoinDifficulty.estimatedSecondsToMineBlock(difficulty, hahesPerSecondHashRate) / 60 / 60.0 / 24
  }
}
